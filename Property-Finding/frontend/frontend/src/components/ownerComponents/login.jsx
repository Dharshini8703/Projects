...
function OwnerLogin(props) {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const res = await axios.post('http://localhost:3000/owners/login', { username }, {
                headers: {
                    'password': password 
                }
            });
        ...
        <div>
            ...
            <div className="form-box" id="form-box">
                <form onSubmit={handleSubmit} className="login-form" id="admin">
                    <h1 className="my-heading">Property Owner Login</h1>
                    <h4 className="sub-heading">We're glad to see you again!</h4>
                    <div className="link">
                        <p>Don't have an account ? <a href="/owner/register" >Click here</a></p>
                    </div>
                    <div >
                    ...
                    <div className="link">
                        <a href="/owner/forgotPassword">Forgot password</a>
                    </div>
