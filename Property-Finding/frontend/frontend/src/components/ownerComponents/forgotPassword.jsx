...
import OwnerResetPassword from './resetPassword';
...
function OwnerForgotPassword() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.post('http://localhost:3000/owners/forgot-password', { email });
            console.log(res);
    ...
    return (
        <div>
            ...
            ) : (<OwnerResetPassword setValidate = {setValidateFunc}/>)}
            <ToastContainer />
        </div>
    )
}
